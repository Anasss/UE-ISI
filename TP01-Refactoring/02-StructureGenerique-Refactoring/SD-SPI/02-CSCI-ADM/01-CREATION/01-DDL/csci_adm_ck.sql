--
--Script de création des contraintes de vérification du CSCI-ADM
--

PROMPT Creating Check Constraint on 'ETUDIANT'
ALTER TABLE ETUDIANT
 ADD (CONSTRAINT CK_ETU_CIVILITE CHECK (SEXE BETWEEN 'H' 
...
PROMPT Creating Check Constraint on 'ENSEIGNANT'
ALTER TABLE ENSEIGNANT
 ADD (CONSTRAINT CK_ENS_CIVILITE CHECK (SEXE BETWEEN 'H' 
AND 'H' OR SEXE BETWEEN 'F' AND 'F' OR SEXE BETWEEN 'L' AND 'L'))
/

PROMPT Creating Check Constraint on 'CANDIDAT'
ALTER TABLE CANDIDAT
 ADD (CONSTRAINT CK_CAN_CIVILITE CHECK (SEXE BETWEEN 'H' 
AND 'H' OR SEXE BETWEEN 'F' AND 'F' OR SEXE BETWEEN 'L' AND 'L'))
/
...
PROMPT Creating Check Constraint on 'CANDIDAT'
ALTER TABLE CANDIDAT
 ADD (CONSTRAINT CK_CAN_SELECTION_ORIGIN CHECK (SELECTION_ORIGINE BETWEEN 'LP' 
...
PROMPT Creating Check Constraint on 'CANDIDAT'
ALTER TABLE CANDIDAT
 ADD (CONSTRAINT CK_CAN_REPONSE_CANDIDAT_ILI CHECK (REPONSE_ILI BETWEEN 'O' AND 'O' OR REPONSE_ILI BETWEEN 'N' AND 'N'))
/
