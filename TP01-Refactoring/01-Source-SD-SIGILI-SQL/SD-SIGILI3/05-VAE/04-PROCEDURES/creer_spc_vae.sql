create or replace PROCEDURE creer_spc_VAE (code_util VARCHAR2) AS
  cursor resultat is  select id_spc
                      from suivi_personnel_competence
                      where code_utilisateur=code_util;
...
BEGIN
  ...
  INSERT INTO SUIVI_PERSONNEL_COMPETENCE(CODE_MCP, CODE_UTILISATEUR, DATE_DEBUT)
  VALUES (TMP_CODE_MCP, code_util, SYSDATE);
